...
export const TOOLS: ToolMeta[] = [
  { 
    ...
    href: '/articles/image-compressor', 
    category: 'Image', 
    featured: true,
  ...
  { 
    ...
    href: '/articles/time-zone-converter', 
    category: 'Utility',
  ...
  { 
    ...
    href: '/articles/currency-converter', 
    category: 'Finance', 
    featured: true,
